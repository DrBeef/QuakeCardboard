...
static void M_Options_Effects_Draw (void)
{
	...
	M_Options_PrintCheckbox("                Decals", false, cl_decals.integer);
...
static void M_Menu_Options_Graphics_AdjustSliders (int dir)
{
	...
	if (options_graphics_cursor == optnum++) Cvar_SetValueQuick (&cl_centreoffset, bound(-150, cl_centreoffset.integer + dir * 5, 150));
...
static void M_Options_Graphics_Draw (void)
{
	...
	M_Options_PrintSlider(  "    Lens Centre Offset", true, cl_centreoffset.integer, -150, 150);
